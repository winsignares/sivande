...
const getProductos = async (id_contrato) => {
    ...
    const response = await apiGet(`http://localhost:5000/api/productos/contrato?id_contrato=${id_contrato}`);
...
const valorContrato = document.getElementById("valorContrato");
      ...
      if (valorContrato) {
        document.getElementById("valorContrato").addEventListener("input", (e) => {
            ...
            const valorContrato = parseInt(document.getElementById("valorContrato").value);
